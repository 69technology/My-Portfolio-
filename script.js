...
function submitForm() {
  ...
  const subjectOk = validateSelect('fsubject', 'fsubjectErr', 'Please select a subject.');
  const msgOk     = validateField('fmessage',  'fmessageErr', 'Please write a message.');
